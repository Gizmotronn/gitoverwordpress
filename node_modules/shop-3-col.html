...
<!-- Mirrored from appscred.com/html/mxtonz/shop-3-col.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Sep 2021 06:38:39 GMT -->
<head>
    <!-- Site information -->
    <meta charset="UTF-8">
...
<body class="page">
    ...
    <div class="page-header">
        <div class="container text-center">
            ...
            <h1 class="page-title">Shop 3 Column</h1>
        </div>
    </div>
    <!-- Page Header End -->
            ...
            <div class="container">
                <div class="row products">
                        <div class="col-md-4 col-sm-6 col-12">
                            <div class="product">
                                <div class="product-thumb">
                                    <img class="img-responsive" src="images/product/3.1.jpg" alt="Product Thumb">
                        ...
                        <div class="col-md-4 col-sm-6 col-12">
                            <div class="product">
                                <div class="product-thumb">
                                    <img class="img-responsive" src="images/product/3.2.jpg" alt="Product Thumb">
                                    <div class="product-thumb-hover">
                                        <a class="btn btn-white" href="#">Add to Cart</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-12">
                            <div class="product">
                                <div class="product-thumb">
                                    <img class="img-responsive" src="images/product/3.3.jpg" alt="Product Thumb">
                                    <div class="product-thumb-hover">
                                        <a class="btn btn-white" href="#">Add to Cart</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-12">
                            <div class="product">
                                <div class="product-thumb">
                                    <img class="img-responsive" src="images/product/3.4.jpg" alt="Product Thumb">
                                    <div class="product-thumb-hover">
                                        <a class="btn btn-white" href="#">Add to Cart</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-12">
                            <div class="product">
                                <div class="product-thumb">
                                    <img class="img-responsive" src="images/product/3.5.jpg" alt="Product Thumb">
                                    <div class="product-thumb-hover">
                                        <a class="btn btn-white" href="#">Add to Cart</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-12">
                            <div class="product">
                                <div class="product-thumb">
                                    <img class="img-responsive" src="images/product/3.6.jpg" alt="Product Thumb">
                                    <div class="product-thumb-hover">
                                        <a class="btn btn-white" href="#">Add to Cart</a>
                                    </div>
                                </div>
...
<!-- Mirrored from appscred.com/html/mxtonz/shop-3-col.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Sep 2021 06:38:57 GMT -->
</html>
