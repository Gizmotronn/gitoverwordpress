...
<!-- Mirrored from appscred.com/html/mxtonz/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Sep 2021 06:39:41 GMT -->
<head>
    <!-- Site information -->
    <meta charset="UTF-8">
...
<body class="page">
    ...
    <div class="main-wrap">
        ...
        <div class="section">
            <div class="fluid-container">
                <div class="fluid-col-1 contact-info-item">
                    <h3 class="contact-title">Press</h3>
                    <h5 class="contact-person">Oliver Liam</h5>
                    <p class="contact-info"><i class="fa fa-phone"></i> +1-0000-000-0000<br/><i class="fa fa-envelope-o"></i> mail@example.com</p>
                </div>
                <div class="fluid-col-1 contact-info-item">
                    <h3 class="contact-title">Management</h3>
                    <h5 class="contact-person">Jack Hobbies</h5>
                    <p class="contact-info"><i class="fa fa-phone"></i> +1-0000-000-0000<br/><i class="fa fa-envelope-o"></i> mail@example.com</p>
                </div>
                <div class="fluid-col-1 contact-info-item">
                    <h3 class="contact-title">Booking</h3>
                    <h5 class="contact-person">Swan M.Lee</h5>
                    <p class="contact-info"><i class="fa fa-phone"></i> +1-0000-000-0000<br/><i class="fa fa-envelope-o"></i> mail@example.com</p>
                </div>
                <div class="fluid-col-1 contact-info-item">
                    <h3 class="contact-title">Label</h3>
                    <h5 class="contact-person">Bob Marlin</h5>
                    <p class="contact-info"><i class="fa fa-phone"></i> +1-0000-000-0000<br/><i class="fa fa-envelope-o"></i> mail@example.com</p>
                </div>
            </div>
        </div>
        ...
        <div class="section form-map-section">
            <div class="fluid-container">
                <div class="fluid-col-2 contact-form-wrap text-white">
                ...
                <div class="fluid-col-2 map-area" id="map-area">
