...
<!-- Mirrored from appscred.com/html/mxtonz/album.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Sep 2021 06:36:11 GMT -->
<head>
    <!-- Site information -->
    <meta charset="UTF-8">
        ...
        <div class="container text-center">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb text-center">
                ...
                <li class="breadcrumb-item active" aria-current="page">Oliver in city</li>
              </ol>
            </nav>
            <h1 class="page-title">Oliver in city</h1>
        </div>
    </div>
    <!-- Page Header End -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="album-image">
                            <img class="img-responsive" src="images/album/single.jpg" alt="Album Image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-album">
                            <h2 class="album-name">About Oliver in City</h2>
                            ...
                            <div class="album-information-list">
                                <p><b class="album-info-item">Artist</b>:<span class="album-info-value">Oliver Liam</span></p>
                                <p><b class="album-info-item">Album</b>:<span class="album-info-value">Oliver in City</span></p>
                                <p><b class="album-info-item">Year</b>:<span class="album-info-value">2018</span></p>
                                <p><b class="album-info-item">#</b>:<span class="album-info-value">2</span></p>
                                <p><b class="album-info-item">Genre</b>:<span class="album-info-value">Hollywood Music</span></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="album-review-wrap">
                            <div id="album-review-carousel" class="album-review-carousel owl-carousel">
                                <div class="album-review">
                                    <blockquote>aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip</blockquote>
                                    ...
                                    <h4 class="reviewer-name">Mathew Alex</h4>
                                    <p class="reviewer-profession">CEO, Alex Music</p>
                                </div>
                                <div class="album-review">
                                    <blockquote>aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip</blockquote>
                                    <div class="review-rating">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="section-header left-style">
                                <h3 class="section-title">Available For <br/>Purchase</h3>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="purchase-button-wrap">
                                <a class="btn btn-border btn-white" href="#"><i class="fa fa-apple"></i> iTunes</a>
                                <a class="btn btn-border btn-white" href="#"><i class="fa fa-android"></i> PLAY STORE</a>
                                <a class="btn btn-border btn-white" href="#"><i class="fa fa-spotify"></i> Spotify</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="section section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12">
                        <div class="section-header text-center">
                            <h3 class="section-title">Popular Video</h3>
                            <p class="section-subtext">we trying hard to make your fresh mind we trying hard to make your fresh mind</p>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from appscred.com/html/mxtonz/album.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Sep 2021 06:36:12 GMT -->
</html>
