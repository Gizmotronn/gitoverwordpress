...
<!-- Mirrored from appscred.com/html/mxtonz/about-singer.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Sep 2021 06:35:21 GMT -->
<head>
    <!-- Site information -->
    <meta charset="UTF-8">
...
<body class="page">
    ...
    <div class="page-header">
        <div class="container text-center">
            ...
            <h1 class="page-title">Olivia Merry</h1>
        </div>
    </div>
    <!-- Page Header End -->
                ...
                <div class="row">
                    <div class="col-lg-6 order-lg-2 col-12">
                        <div class="about-artist">
                            <h2 class="artist-name">Olivia Merry</h2>
                            ...
                            <div class="artist-information-list">
                                <p><b class="artist-info-item">Name</b>:<span class="artist-info-value">Olivia Merry</span></p>
                                <p><b class="artist-info-item">Date of Birth</b>:<span class="artist-info-value">15 February 1993</span></p>
                    ...
                    <div class="col-lg-6 order-lg-1 col-12">
                        <div class="artist-image">
                            <img class="img-responsive" src="images/artist/single.png" alt="Artist Image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="section-header left-style">
                            <h3 class="section-title">Upcoming Stage <br/>Performance</h3>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="stage-countdown-wrap">
                            <h3 class="stage-title">Dashing Rock Fun</h3>
                            <p class="stage-location">Hotel Grand Park, Florida</p>
                            <div class="countdown countdown-stage" data-time="2019/02/18 00:00:00"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12">
                        <div class="section-header text-center">
                            <h3 class="section-title">Latest Music Video</h3>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="plyr-video">
                            <div data-type="youtube" data-video-id="prLGcY6dU-s"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="section">
            <div id="artist-gallery-carousel" class="artist-gallery-carousel owl-carousel">
                <div class="artist-gallery-item">
                    ...
                    <div class="artist-gallery-hover">
                        <div class="artist-gallery-content">
                            <a class="gallery-zoom image-large" href="images/artist/gallery-1.jpg" alt="Gallery Image"><i class="fa fa-search-plus"></i></a>
                ...
                <div class="artist-gallery-item">
                    ...
                    <div class="artist-gallery-hover">
                        <div class="artist-gallery-content">
                            <a class="gallery-zoom image-large" href="images/artist/gallery-2.jpg" alt="Gallery Image"><i class="fa fa-search-plus"></i></a>
                            <h5 class="artist-image-title">Some Memories</h5>
                        </div>
                    </div>
                </div>
                <div class="artist-gallery-item">
                    ...
                    <div class="artist-gallery-hover">
                        <div class="artist-gallery-content">
                            <a class="gallery-zoom image-large" href="images/artist/gallery-3.jpg" alt="Gallery Image"><i class="fa fa-search-plus"></i></a>
                            <h5 class="artist-image-title">Some Memories</h5>
                        </div>
                    </div>
                </div>
                <div class="artist-gallery-item">
                    ...
                    <div class="artist-gallery-hover">
                        <div class="artist-gallery-content">
                            <a class="gallery-zoom image-large" href="images/artist/gallery-4.jpg" alt="Gallery Image"><i class="fa fa-search-plus"></i></a>
                            <h5 class="artist-image-title">Some Memories</h5>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from appscred.com/html/mxtonz/about-singer.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Sep 2021 06:36:11 GMT -->
</html>
